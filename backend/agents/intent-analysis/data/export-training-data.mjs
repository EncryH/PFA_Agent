...
const inputPath = resolve(process.argv[2] || `${here}/training/kisa-intent-review.jsonl`);
const outputPath = resolve(process.argv[3] || `${here}/training/kisa-intent-training.jsonl`);
