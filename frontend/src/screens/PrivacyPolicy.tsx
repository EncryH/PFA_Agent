  ...
  return (
    <div className="flex flex-col gap-4 pb-10">
      ...
      <Section id="device" title="제6조 기기 저장정보·쿠키·외부 콘텐츠">
        <p>광고·행태추적용 쿠키는 사용하지 않습니다. 가족 연결, 보호 설정, 상담, 가족 기록, 피해대응, 문의, 포트폴리오, 큰글씨 설정, 최근 통화 시각은 브라우저 localStorage에 저장됩니다.</p>
      ...
      <Section id="ai" title="제7조 AI 처리와 위험 결정" open>
        ...
        <ul className="flex list-inside list-disc flex-col gap-1 pl-1">
          ...
          <li>거부·설명 요구: 이용자는 AI 위험 분석 결과에 대해 설명을 요구하거나 적용을 거부할 수 있으며, 제12조의 문의 채널을 통해 행사할 수 있습니다</li>
        </ul>
        <p>이용자 입력을 운영팀 자체 AI 모델의 학습·미세조정 자료로 사용하지 않습니다. 외부 AI 서비스(Gemini API)도 유료 API 계약 조건에 따라 입력 데이터를 모델 학습에 사용하지 않습니다. 학습 목적으로 변경할 경우 별도의 목적·항목·보유기간과 동의 절차를 먼저 마련하고, 이용자의 학습 거부권(Opt-out) 행사 방법을 함께 안내합니다.</p>
      </Section>
