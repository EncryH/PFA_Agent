...
```mermaid
xychart-beta
  title "보이스피싱 피해 금액 추이 (억원, 경찰청)"
  x-axis ["2019", "2020", "2021", "2022", "2023", "2024", "2025(1~8월)"]
  y-axis "피해 금액(억원)" 0 --> 10000
  bar [6398, 7000, 7744, 5438, 4472, 8545, 8856]
```

```mermaid
xychart-beta
  title "60대 이상 보이스피싱 피해 비율 추이 (%)"
  x-axis ["2020", "2022", "2024", "2025 상반기"]
  y-axis "비율(%)" 0 --> 40
  line [16, 20, 25, 30.6]
  bar [16, 20, 25, 30.6]
```
